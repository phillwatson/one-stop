...
public class NotificationServiceTest {
    ...
    public void testCreateNotification() throws JsonProcessingException {
        ...
        HashMap<String, Object> params = objectMapper.readValue(notification.getAttributes(), MAP_TYPE);
    ...
    public void testListNotifications_HappyPath() throws JsonProcessingException {
        ...
        User user = User.builder()
            .id(UUID.randomUUID())
            .givenName(randomStrings.nextAlphanumeric(30))
     ...
     */
    private <T> NotificationService.NotificationMapper<T> mockNotificationMapper(List<Notification> expectedNotifications) {
    ...
    private ConsentExpired mockConsentExpired() {
        return ConsentExpired.builder()
            ...
            .institutionId(randomStrings.nextAlphanumeric(30))
            .institutionName(randomStrings.nextAlphanumeric(30))
            .dateExpired(Instant.now())
            .agreementId(randomStrings.nextAlphanumeric(30))
