...
export default function EditAuditReportConfig(props: Props) {
  ...
  return (
    <Grid container direction="column" paddingLeft={{ xs: 0, sm: 1, md: 5, lg: 17 }} paddingRight={{ xs: 0, sm: 1, md: 5, lg: 17 }}>
      <form onSubmit={ handleSubmit }>
        ...
        <Grid container spacing={ 2 } columns={{ xs: 6, md: 12 }}  alignItems="baseline">
          <Item size={{ xs: 6, md: 5 }}>
          ...
          <Item size={{ xs: 6, md: 7 }}>
            <Paper component="fieldset" square={ false } variant="outlined">
