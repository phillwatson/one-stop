...
/**
 * Notifies listeners of the user's cancellation of consent to access their bank account details.
 */
@Getter
@Builder
@NoArgsConstructor
...
public class ConsentCancelled {
    ...
    /**
     * The date-time on which the consent was cancelled.
     */
    ...
    /**
     * The ID of the institution for which consent has been cancelled. This record is
     * held in the rail providing the open-banking service.
     */
    private String institutionId;

    /**
     * The name of the institution for which consent has been cancelled.
     */
